...
const AboutNoida = () => {
  return (
    <section className="max-w-7xl md:mx-auto flex md:flex-row flex-col pb-10 md:pb-20 md:pt-40 pt-20 mx-4">
      <div className="md:w-1/2 w-full md:pr-24 md:order-0 order-1">
        ...
        <button className="md:mt-10 mt-8 text-sm font-medium md:w-fit w-full px-4 py-[10px] border-2 border-tertiary-lightgray border-opacity-80 rounded-md font-para">
          View More
        </button>
      </div>
